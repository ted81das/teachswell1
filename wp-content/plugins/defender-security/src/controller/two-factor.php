			...
			[
				...
				'new_feature' => '<span class="sui-tag sui-tag-beta margin-right-10">' . __( 'Beta', 'defender-security' ) . '</span>'
					. sprintf(
						...
						__( 'Web Authentication is now available. Enable users to authenticate login using their device\'s built-in fingerprint, facial recognition, or an external hardware security key. %1$sLearn more%2$s', 'defender-security' ),
						 '<a target="_blank" href="https://wpmudev.com/docs/wpmu-dev-plugins/defender/#web-authentication">',
						'</a>'
					),
