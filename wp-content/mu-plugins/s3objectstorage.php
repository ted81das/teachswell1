...
//add_filter( 'as3cf_aws_s3_client_args', array( $this, 'minio_s3_client_args' ) );
	...
	public function minio_s3_client_args( $args ) {
		...
		$args['endpoint'] = 'https://s3.us-east-005.backblazeb2.com';
	...
	public function minio_s3_url_domain( $domain, $bucket, $region, $expires, $args ) {
		...
		return 's3.us-east-005.backblazeb2.com/' . $bucket;
	}
	...
	public function wasabi_get_regions( $regions ) {
		$regions = array(
			'ap-northeast-1' => 'Aigency 1',
			'ap-northeast-2' => 'Aigency 2',
			'ap-southeast-1' => 'Aigency 3',
			'ap-southeast-2' => 'Aigency 4',
			'ca-central-1'   => 'Aigency 5',
			'eu-central-1'   => 'Aigency 15',
			'eu-central-2'   => 'Aigency 18',
			'eu-west-1'      => 'Aigency 19',
			'eu-west-2'      => 'Aigency 181',
			'us-west-1'      => 'Aigency 185',
			'us-central-1'   => 'Aigency 189',
			'us-east-1'      => 'Aigency 1845',
			'us-east-2'      => 'Aigency 198',
		);
